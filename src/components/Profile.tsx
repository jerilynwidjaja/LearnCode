...
import { BookOpen, User, LogOut, TrendingUp, Trophy, Sparkles, Info, Brain, Settings, Moon, Sun, BarChart3, AlertTriangle, CheckCircle, Cpu, Zap, RefreshCw, Eye, Code2, Database, Clock, Activity, Loader, Users } from 'lucide-react';
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="flex items-center px-3 py-2 rounded-lg transition-colors text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
              >
