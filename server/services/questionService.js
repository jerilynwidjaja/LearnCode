...
export class QuestionService {
  ...
  static fallbackJavaScriptExecution(code, question) {
    try {
      ...
      // Capture direct function call results
      const originalReturn = [];
      
      // Override common functions to capture their return values
      const captureReturn = (value) => {
        if (value !== undefined) {
          originalReturn.push(String(value));
        }
        return value;
      };
      ...
      try {
        ...
        eval(`
          ...
          // Override global functions to capture returns
        ...
        // Combine console.log output and captured returns
        const allOutput = [...logs, ...originalReturn];
